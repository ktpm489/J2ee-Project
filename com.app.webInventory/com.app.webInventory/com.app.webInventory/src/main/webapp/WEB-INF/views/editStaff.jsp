...
<script src="./resources/js/editStaff.js"></script>
<style>
td {
	padding: 5px 10px;
    ...
    <div id ="main">
      ...
      <div id="right_column_container" width=100% align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>Edit Staff</em></font></H2></td>
            </tr>
            <tr>
              <td><table border="0">
                  <tbody>
                    <tr>
                      ...
                      <td>Staff Name:</td>
                      <td><input id="staffname" type="text" name=""  value="${staffname}"/></td>
                      
                    </tr>
                    <tr>
                      
                      <td>Code Staff:</td>
                      <td><input id="code" type="text" name="" value="${code}" readonly="readonly"/></td>
                  
                    </tr>
                    <tr>
                   
                      <td>Birthday:</td>
                      <td><input id="birthday" type="text" name="ngaysinh"  value="${day}"readonly="readonly"></td>
                    
                    </tr>
                    <tr>
                     
                      <td>Phone Number:</td>
                      <td><input id="phone" type="number" name="" value="${phone}"/></td>
                    ...
                    <tr>
                      ...
                      <td>Address:</td>
                      <td><input id="address" type="text" name="email" value="${address}"></td>
            ...
            <tr>
              <td><br>
                <input type="button" id="editStaff" value="Submit Change" />
                <input type="button"  id="cancelStaff" value="Cancel"/></td>
            </tr>
          </tbody>
        </table>
      </div>
