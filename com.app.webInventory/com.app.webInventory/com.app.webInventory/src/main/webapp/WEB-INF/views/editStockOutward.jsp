...
<html>
<head>
<title>Edit Stock Outward</title>
...
<script type="text/javascript"  src="./resources/js/editStockOutwards.js"></script>
<style>
td {
	padding: 5px 10px;
...
<div id="right_column_container" width=100% align="center" >
...
<form name="fr_move" method="post" autocomplete="off">
  ...
  <table border="2">
    <tbody>
      <tr>
        <td><h2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em> Edit Outward Report</em></font></h2></td>
      </tr>
      <tr>
        <td><table border="0">
            <tbody>
              <!--   <tr>
                ...
                <td><input id="outward_code" type="text" value="${stocktransfer}" /></td>
              </tr>
              <tr>
                <td>Customer Name:</td>
    
                <td><input id="supplier_name" type="text" value="${provider}"  readonly /></td>
              </tr>
              <tr>
                <td>Staff Name:</td>
                <td><input id="staff_name" type="text" value="${staff}"  readonly /></td>
              </tr>
              <tr>
                <td>Order Date:</td>
                <td><input id="order_date" type="text" value="${date}"  readonly></td>
              </tr>
			   <tr>
                <td>Total Amount:</td>
                <td><input id="total_Amount" type="text" value="${amount}" readonly></td>
              </tr>
              <tr>
                <td>Total Price:</td>
                <td><input id="total_price" type="text" value="${price}" readonly></td>
              </tr>
              <tr>
                <td>State Stock Outward:</td>
      ...
      <!--<tr>
		...
		<table  border="1" id="checkTable" class="table table-striped table-hover  table-bordered">
				<thead>
							...
							<tbody>
								<c:forEach items="${stockOutwardDetailList}" var="current">
									<tr>
										<td><c:out value="${current.nameproductId}" /></td>
										<td id="testid"><c:out value="${current.namestockId}" /></td>
										<td><c:out value="${current.numberOutward}" /></td>
      ...
      <tr align="left">
        <td align="left"><br>
          <br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="button" value=" Submit Change" id="submitStockOutwardEdit">
          &nbsp;&nbsp;&nbsp;
          <input type="button" value=" Cancel"  id="cancelStockOutwardEdit">
