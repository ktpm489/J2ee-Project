...
<title>List Stock Transfer </title>
<link rel="stylesheet"
	href="<c:url value="./resources/css/bootstrap.css" /> " type="text/css">
<link rel="stylesheet"
	href="<c:url value="./resources/css/style.css" /> " type="text/css" />
<script src="./resources/js/jquery-1.9.1.js"></script>
<script src="./resources/js/listStockTransfered.js"></script>
<style>
td {
	padding: 5px 10px;
    ...
    <div id ="main">
      ...
      <div id="right_column_container" width=100% align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>List Stock Transfer</em></font></H2></td>
            </tr>
            <tr>
                      <td><input type="button" id="addnewStockTransfer" value="Add New"   /></td>
               </tr>
            <tr>
              <td>
							...
							<thead>
								<tr>
									...
									<th>Total Amount</th>
									<th>Is Active</th>
									<th>Delete Stock Transfer</th>
									<th>Edit Stock Transfer</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${stockTransferList}" var="current">
									<tr>
										<td class="hidden"><c:out value="${current.transferID}" /></td>
										<td id="testid"><c:out value="${current.transferName}" /></td>
										<td><c:out value="${current.nameStaffId}" /></td>
										<td><c:out value="${current.dateTransfered}" /></td>
										<td><c:out value="${current.totalNumber}" /></td>
										<td><c:out value="${current.totalAmount}" /></td>
