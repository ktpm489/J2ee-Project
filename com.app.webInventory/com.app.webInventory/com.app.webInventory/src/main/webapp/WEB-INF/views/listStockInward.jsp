...
<script src="./resources/js/listStockInwards.js"></script>
<style>
td {
	padding: 5px 10px;
    ...
    <div id ="main">
      ...
      <div id="right_column_container" width=100% align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>List Stock Inward</em></font></H2></td>
            </tr>
            <tr>
                      <td><input type="button" id="addnewCheckInward" value="Add New"   /></td>
               </tr>
            <tr>
              <td>
							...
							<thead>
								<tr>
									...
									<th>Code Stock Inward</th>
									<th>Provider</th>
									<th>Staff Check</th>
									<th>Date Inward</th>
									<th>Is Active</th>
									<th>Delete Stock Inward</th>
									<th>Edit Stock Inward</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${stockInwardListLoad}" var="current">
									<tr>
										<td class="hidden"><c:out value="${current.inwardId}" /></td>
										<td id="testid"><c:out value="${current.inwardName}" /></td>
										<td><c:out value="${current.nameproviderId}" /></td>
										<td><c:out value="${current.namestaffId}" /></td>
										<td><c:out value="${current.dateInward}" /></td>
