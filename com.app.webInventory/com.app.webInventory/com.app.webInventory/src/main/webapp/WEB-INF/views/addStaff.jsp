...
<script src="./resources/js/addStaffs.js"></script>
    ...
    <div id ="main">
      ...
      <div id="right_column_container" width=100% align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>Add Staff</em></font></H2></td>
            </tr>
            <tr>
              <td><table border="0">
                  <tbody>
                    <tr>
                      <td></td>
                      <td>Staff Name:</td>
                      <td><input id="staffname" type="text" name="" /></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td></td>
                      <td>Staff Code:</td>
                      <td><input id="staffcode" type="text" name="" /></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td></td>
                      <td>Birthday:</td>
                      <td><!--    <input type="hidden" name="hd_OrderDate" ,="" id="hd_OrderDate" value="0">-->
                  <input class="datepicker" type="text">
                    ...
                    <tr>
                      <td></td>
                      <td>Phone Number:</td>
                      <td><input id="phone" type="number" name="" /></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td></td>
                    ...
                    <tr>
                      ...
                      <td valign="top"><textarea  id="address" row="4" name="" cols="40">
                        </textarea></td>
                      <td></td>
                    </tr>
                    <tr>
            ...
            <tr>
              <td><br>
                <input  id="submitStaff" type="button" value="Submit" />
                <input  id="cancelStaff" type="button" value="Cancel"/></td>
            </tr>
          </tbody>
        </table>
      </div>
