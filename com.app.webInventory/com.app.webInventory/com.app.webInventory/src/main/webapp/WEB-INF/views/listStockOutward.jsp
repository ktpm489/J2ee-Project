...
<title>List Stock Inward </title>
<link rel="stylesheet"
	href="<c:url value="./resources/css/bootstrap.css" /> " type="text/css">
<link rel="stylesheet"
	href="<c:url value="./resources/css/style.css" /> " type="text/css" />
<script src="./resources/js/jquery-1.9.1.js"></script>
<script src="./resources/js/listStockOutward.js"></script>
<style>
td {
	padding: 5px 10px;
    ...
    <div id ="main">
      ...
      <div id="right_column_container" width=100% align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>List Stock Outward</em></font></H2></td>
            </tr>
            <tr>
                      <td><input type="button" id="addnewCheckOutward" value="Add New"   /></td>
               </tr>
            <tr>
              <td>
							...
							<thead>
								<tr>
									...
									<th>Code Stock Outward</th>
									<th>Customer </th>
									<th>Staff  Outward </th>
									<th>Date Outward </th>
									<th>Is Active</th>
									<th>Delete Stock Outward </th>
									<th>Edit Stock Outward </th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${stockOutwardListLoad}" var="current">
									<tr>
										<td class="hidden"><c:out value="${current.outwardId}" /></td>
										<td id="testid"><c:out value="${current.outwardName}" /></td>
										<td><c:out value="${current.namecustomerId}" /></td>
										<td><c:out value="${current.namestaffId}" /></td>
										<td><c:out value="${current.dateOutward}" /></td>
										<td><c:out value="${current.statusCheck}" /></td>
