...
<script src="./resources/js/editCustomer.js"></script>
<style>
td {
	padding: 5px 10px;
    ...
    <div id ="main">
      ...
      <div id="right_column_container" align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>Edit Customer </em></font></H2></td>
            </tr>
            <tr>
              <td><table border="0">
                  <tbody>
                    <tr>
                      ...
                      <td >Customer Name:</td>
                      <td ><input id="customer_name" type="text" name="" value="${customername}"/></td>
            ...
            <tr>
              <td><br>
                <input type="button"  id="editCustomer" value="Submit Change" />
                <input type="button"   id="cancelCustomer" value="Cancel"/></td>
            </tr>
          </tbody>
        </table>
      </div>
