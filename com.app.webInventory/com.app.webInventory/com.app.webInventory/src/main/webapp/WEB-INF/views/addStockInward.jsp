...
<title>Add New Stock Inward</title>
<link rel="stylesheet"
...
<script src="./resources/js/addStockInwards.js"></script>
<script>
      ...
      <li> <a class="menu_item" href="http://localhost:8080/inventory/aboutTeam" > About</a> </li>
							...
							<tbody>
								...
								<tr>
									<td><table border="0">
											<tbody>
												<tr>
													<td>Code Stock Inward:</td>
													<td><input id="stockinward" type="text" name="stock_name" ></td>
													
												</tr>
												<tr>
													<td>Supplier Name:</td>
													<!--   <td><select name="se_shipfromid" size="1" onchange="">
                    
                          <option value="23">Argaiv Erector Systems Inc</option>
                          <option value="22">Drof</option>
                          <option value="7">MainStore</option>
                          <option value="4">Shelf 5</option>
                          <option value="2">Store1</option>
                          <option value="3">WIP</option>                  </select></td>-->
													<td><select id="supplier">
															<c:forEach items="${providerList}" var="current1">
																<option
																	value="<c:out value="${current1.providerId}"></c:out> ">
																	<c:out value="${current1.providerName}">
																	</c:out>
																</option>
															</c:forEach>
													</select></td>
												...
												<tr>
													<td>Stock Name:</td>
													<td><select id="stock">
															<c:forEach items="${istockList}" var="current1">
																<option
	    ...
	    <tr>
	    	...
	    	<td><input type="button" value="remove" class="btn-remove" /></td>
											...
											<tfoot>
												<tr>
													<td colspan="5" style="text-align: right">Total Price
														:</td>
										...
										</table> <input type="button" value="Add new item" id="add_item" /> <input
										type="button" value="Save" id="save" /></td>
								</tr>
								...
								<tr align="left">
									<td align="left"><br> <br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button"
										value=" Submit Change" id="submitStockInward">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button"
										value=" Cancel " id="cancelStockInward" /> <br> &nbsp; <input
