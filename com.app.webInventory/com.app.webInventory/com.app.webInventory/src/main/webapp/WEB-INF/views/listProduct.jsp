...
<script src="./resources/js/listProduct.js"></script>
<style>
td {
	padding: 5px 10px;
    ...
    <div id ="main">
      ...
      <div id="right_column_container" width=100% align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>List Product </em></font></H2></td>
            </tr>
            <tr>
                      <td><input type="button" id="addnewProduct" value="Add New"   /></td>
               </tr>
            <tr>
              <td>
							...
							<tbody>
								<c:forEach items="${productListLoad}" var="current">
									<tr>
										<td class="hidden"><c:out value="${current.productId}" /></td>
										<td id="testid"><c:out value="${current.productName}" /></td>
										<td><c:out value="${current.nameTypeId}" /></td>
