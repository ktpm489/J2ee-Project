...
<script src="./resources/js/addProviders.js"></script>
</head>
    ...
    <div id ="main">
      ...
      <div id="right_column_container" width=100% align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>Add Provider</em></font></H2></td>
            </tr>
            <tr>
              <td><table border="0">
                  <tbody>
                    <tr>
                      <td></td>
                      <td>Provider:</td>
                      <td><input  id="provider" type="text" name="" /></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td></td>
                    ...
                    <tr>
                      <td></td>
                      <td>Email:</td>
                      <td><input id="email" type="email" name="" /></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td></td>
                      <td>Website:</td>
                      <td><input id="web" type="text" name="" /></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td></td>
                      <td valign="top">Description:</td>
                      <td valign="top"><textarea row="4"  id="descript" sname="" cols="40"></textarea>
                        </td>
                      <td></td>
                    </tr>
                    <tr>
            ...
            <tr>
              <td><br>
                <input id="submitProvider" type="button" value="Submit" />
                <input id="cancelProvider" type="button" value="Cancel"/></td>
            </tr>
          </tbody>
        </table>
      </div>
