...
<script src="./resources/js/listProvider.js"></script>
<style>
td {
	padding: 5px 10px;
    ...
    <div id ="main">
      ...
      <div id="right_column_container" width=100% align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>List Provider </em></font></H2></td>
            </tr>
            <tr>
                      <td><input type="button" id="addnewProvider" value="Add New"   /></td>
               </tr>
            <tr>
              <td>
							...
							<tbody>
								<c:forEach items="${providerList}" var="current">
									<tr>
										<td class="hidden"><c:out value="${current.providerId}" /></td>
										<td id="testid"><c:out value="${current.providerName}" /></td>
