...
<title>List Stock Check </title>
<link rel="stylesheet"
	href="<c:url value="./resources/css/bootstrap.css" /> " type="text/css">
<link rel="stylesheet"
	href="<c:url value="./resources/css/style.css" /> " type="text/css" />
<script src="./resources/js/jquery-1.9.1.js"></script>
<script src="./resources/js/listStockCheck.js"></script>
<style>
td {
	padding: 5px 10px;
    ...
    <div id ="main">
      ...
      <div id="right_column_container" width=100% align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>List Stock Check</em></font></H2></td>
            </tr>
            <tr>
                      <td><input type="button" id="addnewCheckStock" value="Add New"   /></td>
               </tr>
            <tr>
              <td>
							...
							<thead>
								<tr>
									...
									<th>Code Stock Check</th>
									<th>Staff Check</th>
									<th>Date Check</th>
									<th>Is Active</th>
									<th>Delete Stock Check</th>
									<th>Edit Stock Check</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${stockCheckListLoad}" var="current">
									<tr>
										<td class="hidden"><c:out value="${current.checkId}" /></td>
										<td id="testid"><c:out value="${current.checkName}" /></td>
										<td><c:out value="${current.staffName}" /></td>
										<td><c:out value="${current.dateCheck}" /></td>
