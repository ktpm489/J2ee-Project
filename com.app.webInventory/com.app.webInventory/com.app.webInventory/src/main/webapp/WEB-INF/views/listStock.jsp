...
<script src="./resources/js/listStock.js"></script>
<style>
td {
	padding: 5px 10px;
    ...
    <div id ="main">
      ...
      <div id="right_column_container" width=100% align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>List Stock </em></font></H2></td>
            </tr>
            <tr>
                      <td><input type="button" id="addnewStock" value="Add New"   /></td>
               </tr>
            <tr>
              <td>
							...
							<tbody>
								<c:forEach items="${stockListLoad}" var="current">
									<tr>
										<td class="hidden"><c:out value="${current.stockId}" /></td>
										<td id="testid"><c:out value="${current.stockName}" /></td>
										<td><c:out value="${current.nameStockTypeId}" /></td>
										<td><c:out value="${current.nameManagerId}" /></td>
