...
<script src="./resources/js/addCustomers.js"></script>
</head>
    ...
    <div id ="main">
      ...
      <div id="right_column_container" width=100% align="left" >
        <table border="2">
          <tbody>
            <tr>
              <td><H2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em>Add Customer</em></font></H2></td>
            </tr>
            <tr>
              <td><table border="0">
                  <tbody>
                    <tr>
                      <td></td>
                      <td>Customer:</td>
                      <td><input  id="customer" type="text" name="" /></td>
                      <td></td>
                    </tr>
                    <tr>
                      <td></td>
            ...
            <tr>
              <td><br>
                <input id="submitCustomer" type="button" value="Submit" />
                <input id="cancelCustomer" type="button" value="Cancel"/></td>
            </tr>
          </tbody>
        </table>
      </div>
