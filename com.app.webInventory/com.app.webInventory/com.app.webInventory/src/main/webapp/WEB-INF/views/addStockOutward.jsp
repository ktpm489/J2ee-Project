...
<script src="./resources/js/addStockOutward.js"></script>
<script type="text/javascript">
							...
							<tbody>
								...
								<tr>
									<td><table border="0">
											<tbody>
												<tr>
													<td>Code Stock Outward:</td>
													<td><input id="stockoutward" type="text"
														name="stock_name"></td>
                          ...
                          <option value="3">WIP</option>                  </select></td>-->
													<td><select id="supplier">
															<c:forEach items="${providerList}" var="current1">
																<option
																	value="<c:out value="${current1.customerId}"></c:out> ">
																	<c:out value="${current1.customerName}">
																	</c:out>
																</option>
															</c:forEach>
													</select></td>
	    ...
	    <tr>
	    	...
	    	<td><input type="button" value="remove" class="btn-remove" /></td>
								...
								<tr align="left">
									<td align="left"><br> <br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button"
										value=" Submit Change" id="submitStockOutward">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button"
										value=" Cancel " id="cancelStockOutward" /> <br> &nbsp; <input
