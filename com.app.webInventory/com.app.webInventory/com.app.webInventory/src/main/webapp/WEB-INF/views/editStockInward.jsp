...
<script type="text/javascript"  src="./resources/js/editStockInwardss.js"></script>
<style>
td {
	padding: 5px 10px;
...
<form name="fr_move" method="post" autocomplete="off">
  ...
  <table border="2">
    <tbody>
      <tr>
        <td><h2 align="center"><font color="#FF0000" size="+2" face="Arial, Arial, Helvetica"><em> Edit Inward Report</em></font></h2></td>
      </tr>
      <tr>
        <td><table border="0">
            <tbody>
              <!--   <tr>
                ...
                <td><input id="inward_code" type="text" value="${stocktransfer}" /></td>
              </tr>
              <tr>
                <td>Supplier Name:</td>
      ...
      <!--<tr>
		...
		<table  border="1" id="checkTable" class="table table-striped table-hover  table-bordered">
				<thead>
							...
							<tbody>
								<c:forEach items="${stockInwardDetailList}" var="current">
									<tr>
										<td><c:out value="${current.nameproduct}" /></td>
										<td id="testid"><c:out value="${current.namest}" /></td>
										<td><c:out value="${current.numIn}" /></td>
      ...
      <tr align="left">
        <td align="left"><br>
          <br>
          &nbsp;&nbsp;
          <input type="button" value="Submit Change" id="submitStockInwardEdit">
          &nbsp;&nbsp;&nbsp;
          <input type="button" value="Cancel"  id="cancelStockInwardEdit">
